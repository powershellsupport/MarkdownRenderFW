#
# Module manifest for module 'MarkdownRender'
#
...
GUID = 'c9cab0b2-640a-4663-b5a1-bd23916572a2'
...
NestedModules = @('Markdig.Signed.dll','System.Buffers.dll','System.Memory.dll','System.Numerics.Vectors.dll','System.Runtime.CompilerServices.Unsafe.dll','MarkdownRender.dll')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = @('ConvertFrom-Markdown')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Optimalization, inputobject and AsVT100 support'
