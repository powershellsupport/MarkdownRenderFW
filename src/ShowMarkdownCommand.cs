...
namespace MarkdownRender
{
    ...
    {
        /// <summary>
        /// Gets or sets InputObject of type MarkdownRender.MarkdownInfo to display.
        /// </summary>
        ...
        {
            _powerShell.AddCommand("MarkdownRender\\ConvertFrom-Markdown").AddParameter(parameter, input);
            if (!UseBrowser)
            {
